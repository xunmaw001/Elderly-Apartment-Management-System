...
public class JiaofeixinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,JiaofeixinxiEntity jiaofeixinxi, 
		...
		if(tableName.equals("laoren")) {
			jiaofeixinxi.setLaorenbianhao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yuangong")) {
			jiaofeixinxi.setYuangonggonghao((String)request.getSession().getAttribute("username"));
		}
