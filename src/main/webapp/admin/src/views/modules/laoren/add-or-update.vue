<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="患病史" prop="huanbingshi">
          <el-input v-model="ruleForm.huanbingshi" 
              placeholder="患病史" clearable  :readonly="ro.huanbingshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="患病史" prop="huanbingshi">
              <el-input v-model="ruleForm.huanbingshi" 
                placeholder="患病史" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
