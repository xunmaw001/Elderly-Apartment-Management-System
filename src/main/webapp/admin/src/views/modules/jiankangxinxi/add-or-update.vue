<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服药信息" prop="fuyaoxinxi">
          <el-input v-model="ruleForm.fuyaoxinxi" 
              placeholder="服药信息" clearable  :readonly="ro.fuyaoxinxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服药信息" prop="fuyaoxinxi">
              <el-input v-model="ruleForm.fuyaoxinxi" 
                placeholder="服药信息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="异常处理" prop="yichangchuli">
          <el-input v-model="ruleForm.yichangchuli" 
              placeholder="异常处理" clearable  :readonly="ro.yichangchuli"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="异常处理" prop="yichangchuli">
              <el-input v-model="ruleForm.yichangchuli" 
                placeholder="异常处理" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="病例信息" prop="binglixinxi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="病例信息"
                  v-model="ruleForm.binglixinxi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.binglixinxi" label="病例信息" prop="binglixinxi">
                    <span>{{ruleForm.binglixinxi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxidianhua = true;
          ...
          if(o=='binglixinxi'){
            this.ruleForm.binglixinxi = obj[o];
	    this.ro.binglixinxi = true;
            continue;
          }
          if(o=='fuyaoxinxi'){
            this.ruleForm.fuyaoxinxi = obj[o];
	    this.ro.fuyaoxinxi = true;
            continue;
          }
          if(o=='yichangchuli'){
            this.ruleForm.yichangchuli = obj[o];
	    this.ro.yichangchuli = true;
            continue;
          }
          if(o=='dengjiriqi'){
