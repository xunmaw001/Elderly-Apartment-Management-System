<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="访客备注" prop="fangkebeizhu">
          <el-input v-model="ruleForm.fangkebeizhu" 
              placeholder="访客备注" clearable  :readonly="ro.fangkebeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="访客备注" prop="fangkebeizhu">
              <el-input v-model="ruleForm.fangkebeizhu" 
                placeholder="访客备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="来访日期" prop="laifangriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.laifangriqi" 
                type="date"
                placeholder="来访日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.laifangriqi" label="来访日期" prop="laifangriqi">
              <el-input v-model="ruleForm.laifangriqi" 
                placeholder="来访日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="访客手机" prop="fangkeshouji">
          <el-input v-model="ruleForm.fangkeshouji" 
              placeholder="访客手机" clearable  :readonly="ro.fangkeshouji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="访客手机" prop="fangkeshouji">
              <el-input v-model="ruleForm.fangkeshouji" 
                placeholder="访客手机" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	yuangongxingming : false,
      ...
      rules: {
          ...
          fangkeshouji: [
                { required: true, message: '访客手机不能为空', trigger: 'blur' },
                { validator: validateMobile, trigger: 'blur' },
          ],
          yuangonggonghao: [
          ],
  ...
  created() {
	this.ruleForm.laifangriqi = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fangjianbianhao = true;
          ...
          if(o=='fangkebeizhu'){
            this.ruleForm.fangkebeizhu = obj[o];
	    this.ro.fangkebeizhu = true;
            continue;
          }
          if(o=='laorenbianhao'){
	    ...
	    this.ro.lianxidianhua = true;
          ...
          if(o=='laifangriqi'){
            this.ruleForm.laifangriqi = obj[o];
	    this.ro.laifangriqi = true;
            continue;
          }
          if(o=='fangkexingming'){
	    ...
	    this.ro.fangkexingming = true;
          ...
          if(o=='fangkeshouji'){
            this.ruleForm.fangkeshouji = obj[o];
	    this.ro.fangkeshouji = true;
            continue;
          }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `fangkejilu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fangkejiluCrossAddOrUpdateFlag = false;
                  this.parent.search();
